...
jre: native
	...
	cd $(SOURCEDIR)/depends; \
	$(call METHOD_JAVA_UNPACK,8,'https://files.catbox.moe/3a8tl5.zip'); \
	$(call METHOD_JAVA_UNPACK,17,'https://files.catbox.moe/o53mpl.zip'); \
	$(call METHOD_JAVA_UNPACK,21,'https://files.catbox.moe/l0jqos.zip'); \
