...
jre: native
	...
	cd $(SOURCEDIR)/depends; \
	$(call METHOD_JAVA_UNPACK,8,'https://github.com/ivillami0005/angelauramc-openjdk-build/releases/download/jdk/jre8-ios-aarch64.zip'); \
	$(call METHOD_JAVA_UNPACK,17,'https://github.com/ivillami0005/angelauramc-openjdk-build/releases/download/jdk/jre17-aarch64.zip'); \
	$(call METHOD_JAVA_UNPACK,21,'https://github.com/ivillami0005/angelauramc-openjdk-build/releases/download/jdk/jre21-aarch64.zip'); \
